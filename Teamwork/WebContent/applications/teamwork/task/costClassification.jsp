...
<%
  ...
  if (!pageState.screenRunning) {
    ...
    if (Commands.SAVE.equals(pageState.command)) {
      ...
      CostClassification t = (CostClassification) PersistenceHome.findByPrimaryKey(CostClassification.class, pageState.mainObjectId);
...
%><script>$("#TASK_MENU").addClass('selected');</script><%
    ...
    for (CostClassification tt : tts) {
      ...
      <td align="center"><%ButtonLink.getDeleteInstanceForList("costClassification.jsp",tt,request).toHtml(pageContext);%></td></tr> <%
