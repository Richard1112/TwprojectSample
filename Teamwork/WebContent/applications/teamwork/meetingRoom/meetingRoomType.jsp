<%@ page import="com.twproject.operator.TeamworkOperator, com.twproject.security.SecurityBricks, 
com.twproject.security.TeamworkPermissions, 
com.twproject.task.MeetingRoomType, 
com.twproject.waf.TeamworkPopUpScreen, 
org.jblooming.ontology.businessLogic.DeleteHelper, 
org.jblooming.oql.OqlQuery, org.jblooming.persistence.PersistenceHome, 
org.jblooming.persistence.exceptions.PersistenceException, 
org.jblooming.security.Area, org.jblooming.waf.ActionUtilities, 
org.jblooming.waf.ScreenArea, org.jblooming.waf.SessionState, 
...
org.jblooming.waf.html.input.TextField, org.jblooming.waf.html.state.Form, org.jblooming.waf.settings.I18n, org.jblooming.waf.view.ClientEntry, org.jblooming.waf.view.PageSeed, org.jblooming.waf.view.PageState, java.text.ParseException, java.util.List, java.util.Map, java.util.Set" %>
<%
  ...
  if (!pageState.screenRunning) {
    ...
    if (Commands.SAVE.equals(pageState.command)) {
      ...
      for (String id : map.keySet()) {
        ...
        try {
          MeetingRoomType t = (MeetingRoomType) PersistenceHome.findByPrimaryKey(MeetingRoomType.class, id);
      ...
      if (newDesc != null) {
        try {
          MeetingRoomType t = new MeetingRoomType();
      ...
      MeetingRoomType t = (MeetingRoomType) PersistenceHome.findByPrimaryKey(MeetingRoomType.class, pageState.mainObjectId);
...
%><script>$("#ISSUES_MENU").addClass('selected');</script><%
    ...
    String hql = "from " + MeetingRoomType.class.getName() + " as tt ";
    if (areas != null)
      hql = hql + " where tt.area in (:areas)";
    OqlQuery oql = new OqlQuery(hql);
    if (areas != null)
      oql.getQuery().setParameterList("areas", areas);
    List<MeetingRoomType> tts = oql.list();
...
<table class="table">
  <tr>
    ...
    for (MeetingRoomType tt : tts) {
      ...
      <td align="center"><%ButtonLink.getDeleteInstanceForList("MeetingRoomType.jsp",tt,request).toHtml(pageContext);%></td></tr><%
